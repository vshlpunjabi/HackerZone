...
<center>
	<div class="wrap">
        ...
        <a href="index.php"><img src="images/links_03.gif" class="imagewarp" name="img1" /></a> |
				...
				<?php } ?>
        <div class="main" style="background-image:url(images/contactus2.gif);" align="center">
        <div style="position:absolute;z-index:2; width:500px;">
        		<div style="padding-top:80px; padding-left:80px; font-family:Tahoma, Verdana;;"><strong>For any queries or bugs</strong></div>
        		<div style="background-color:#000000; padding-top:60px; margin-left:150px; font-family:Tahoma, Verdana; line-height:55px;" align="center">
                <strong>Vishal Punjabi   - 	9833228457<br/>

Kamal Wadhwa - 9850029255<br/>

or<br/>
mailat: isaac10hackerzone@gmail.com
</strong><br />
