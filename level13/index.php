<?php
	...
	else if($_SESSION['arenalevel'] == 13){
...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/level13.gif);" align="center">
       <div id="mycontent" style="position:absolute;z-index:2; text-align:center; margin-top:100px; font-size:24px; font-family:Tahoma, Verdana; line-height:35px; width:500px; padding-left:40px;">
       <br />
       Hey guyz there is a music launch of the movie Anjaana Anjaani. All you need to do is to Download their songs.<br /><a href="http://level13.isgreat.org/" target="_blank" style="color:#FFFFFF">Click Here To Download</a>
       <form action="index.php" method="post">
        	<input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:145px; margin-left:45px; width:290px;" name="answer" /><br />
