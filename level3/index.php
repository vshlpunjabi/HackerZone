...
<center>
	<div class="wrap">
        ...
        <a href="../index.php"><img src="../images/links_03.gif" class="imagewarp" name="img1" /></a> |		   
				...
				<?php echo $link; ?>
        <div class="main" style="background-image:url(../images/level3.gif);" align="center">
       ...
       <p style="text-align:center;">No doubt,your sister is a good web designer to escape the password from you,arn't you a good hacker to unescape it..</p>
       <form action="index.php" method="post">
        	<input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:168px; margin-left:127px; width:290px;" name="answer" /><br />
            
            <input type="submit" name="submit" value="" style=" font-family:Arial, Helvetica, sans-serif; font-size:22px; background-color:#000000; border-style:hidden; border-color:#000000; background:none; text-shadow:#000000; color:#ffffff;  margin-top:58px; margin-left:133px; width:290px;" />
            </form>
