...
<!--Aaah!!so you reached here but no use,ive disabled the source code--> 
...
<!--
<meta http-equiv="File-Type" content="passwd.txt" />
-->
...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/level4.gif);" align="center">
       ...
       <p align="center">Peter is also just like you (a noob,hehe!!) cant keep passwords in his volatile brain so maintains a different file for himself to recall it but beware he is smarter than you!!</p>
       <form action="index.php" method="post">
        	<input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:135px; margin-left:127px; width:290px;" name="answer" /><br />
