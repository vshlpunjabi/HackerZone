...
?>
<!-- you are wasting your time looking at the sourcecode,you are too far go BACK think like a noob...you are at lvl 1! -->
...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/home.gif);" align="center">
       <div id="mycontent" align="center" style="position:absolute;z-index:2; margin-top:100px; font-size:22px; font-family:Tahoma, Verdana; line-height:35px; width:400px; padding-left:40px; margin-left:70px;">		
       
       <form action="index.php" method="post">
        	<input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:322px; margin-left:7px; width:290px;" name="answer" /><br />
