...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/level12.gif);" align="center">
       <div id="mycontent" style="position:absolute;z-index:2; text-align:center; margin-top:100px; font-family:Tahoma, Verdana; font-size:24px; line-height:35px; width:500px; padding-left:40px;">       
       <a href="win/index.php" target="_blank"><p style="color:#FFFFFF; padding-top:100px;">Click Here To Logon to Windows</p></a>    
