...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/level6.gif);" align="center">
       ...
       <p style="text-align:center;">Art of hiding stuff in stuff so that others do not find your stuff</p>
	   <img src="../images/stuff/*.jpg" width="0px" height="0px" />
       <form action="index.php" method="post">
        	<input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:204px; margin-left:127px; width:290px;" name="answer" /><br />
