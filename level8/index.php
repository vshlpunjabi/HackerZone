<?php
	...
	if ($_SESSION['uid']==0) {
		...
		if(isset($_POST['submit']))
		{
			...
			{
				$monitor->checkMe($_POST['password']);
			}
			else
			{
				$monitor->wrong=true;
...
<center>
	<div class="wrap">
        ...
        <div class="main" style="background-image:url(../images/level8.gif);" align="center">
       ...
       Do you really thing google is your best friend.I dont think so he knows what the password is..
       <form action="index.php" method="post">
        	<input type="text" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:190px; margin-left:127px; width:290px;" name="username" /><br />
            <input type="password" style="background:none; border-style:hidden; text-align:center; border-color:#000000; color:#FFFFFF; margin-top:40px; margin-left:127px; width:290px;" name="password" /><br />            
